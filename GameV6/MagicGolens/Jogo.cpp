...
{
	jogador1 = new Jogador(jogador, sf::Vector2f(118.f, 144.f), sf::Vector2f(400.f, 400.f), sf::Vector2f(0.f, 0.f), "text/fallenAngel.png", GerenciadorAtualizacoes.getTempo(), GerenciadorGrafico.getJanela());
